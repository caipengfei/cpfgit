...
namespace qch.core
{
    ...
    public class cvt
    {
        ...
        public static Boolean IsBool( String str )
        {
            ...
            if (EqualsIgnoreCase( str, "true" ) || EqualsIgnoreCase( str, "false" )) return true;
        ...
        public static String ToDayString( DateTime day )
        {
            ...
            if (IsDayEqual( day, today )) return "今天";
            if (IsDayEqual( day, today.AddDays( -1 ) )) return "昨天";
            if (IsDayEqual( day, today.AddDays( -2 ) )) return "前天";
        ...
        public static String ToTimeString( DateTime t )
        {
            ...
            if (cvt.IsDayEqual( t, now.AddDays( -1 ) )) return "昨天";
            if (cvt.IsDayEqual( t, now.AddDays( -2 ) )) return "前天";
        ...
        public static long[] ToLongArray( String myids )
        {
            ...
            if (IsNullOrEmpty( myids )) return new long[] { };
        ...
        public static int[] ToIntArray( String myids )
        {
            ...
            if (IsNullOrEmpty( myids )) return new int[] { };
