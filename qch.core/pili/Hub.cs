...
namespace pili_sdk_csharp.pili
{
    ...
    public class Hub
    {
        ...
        {
            return API.listStreams(mCredentials, mHubName, null, 0, null,false);
        }


        public virtual StreamList listStreams(string marker, long limit)
        {
            return API.listStreams(mCredentials, mHubName, marker, limit, null, false);
        }


        public virtual StreamList listStreams(string marker, long limit, string titlePrefix)
        {
            return API.listStreams(mCredentials, mHubName, marker, limit, titlePrefix, false);
        }
