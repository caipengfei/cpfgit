...
{ 
	...
	{ 		
       ...
       public string GetPublicKey(string key)
        {
            string start = "<RSAKeyValue><Modulus>";
            string end = "</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
            return key.Substring(start.Length, key.Length - start.Length - end.Length);
        }
        //合并为真实的key
        /// <summary>
        /// 获取真实的密钥，xml格式
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public string GetPublicXmlKey(string key)
        {
            string start = "<RSAKeyValue><Modulus>";
            string end = "</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
