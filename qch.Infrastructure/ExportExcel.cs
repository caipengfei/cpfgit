    ...
    public class ExportExcel
    {
        ...
        public void ExportData(GridView obj)
        {
            try
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=会员卡报表" + filename + ".xls");
                HttpContext.Current.Response.ContentType = "application/ms-excel";
                HttpContext.Current.Response.Charset = "GB2312";
        ...
        /// <param name="filename">导出的文件名，例如f.xls</param>
        public void ExportData(GridView obj,string filename)
        {
            try
            {
                string style = "";
