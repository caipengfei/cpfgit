<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityReply.aspx.cs" Inherits="Maticsoft.Web.QCH_Activity.ActivityReply" %>
    ...
    <script type="text/javascript">
        ...
        function InitGrid() {
            ...
            $("#maingrid").ligerGrid({
                ...
                { display: '内容', isSort: true, name: 't_Talk_FromContent', align: "center",width:"30%" },
                 {
                     display: '评论时间', isAllowHide: false, isSort: true,
                ...
                parms: [
                  { name: "Action", value: 'GetActivityReply' },
        ...
        function f_delete(guid) {
            $.ligerDialog.confirm("确认删除此信息吗?", function (result) {
                if (result) {
                    var JsonData = { Action: "DelActivityReply", Guid: guid };
