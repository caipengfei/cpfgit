<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityList.aspx.cs" Inherits="Maticsoft.Web.QCH_Activity.ActivityList" %>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-bottom: 10px;">
            <tr>
                ...
                <td id="btnbox">
                    ...
                    <input type="button" value="审核" id="btnAudit" class="l-button l-button-submit" style="margin-left: 20px; display: none"
                        onclick="onedit('', 'audit')" />
                    <input type="button" value="推荐" id="btnUp" class="l-button l-button-submit" style="margin-left: 20px; display: none"
                        onclick="onedit('', 'up')" />
                </td>
            </tr>
        </table>
