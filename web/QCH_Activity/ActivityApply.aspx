<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityApply.aspx.cs" Inherits="Maticsoft.Web.QCH_Activity.ActivityApply" %>
    ...
    <script type="text/javascript">
        ...
        function InitGrid() {
            ...
            $("#maingrid").ligerGrid({
                ...
                { display: '姓名', isSort: true, name: 't_ActivityApply_UserName', align: "center" },
                 {
                     display: '报名时间', isAllowHide: false, isSort: true,
                ...
                parms: [
                  { name: "Action", value: 'GetActivityApply' },
        ...
        function f_delete(guid) {
            $.ligerDialog.confirm("确认删除此信息吗?", function (result) {
                if (result) {
                    var JsonData = { Action: "DelActivityApply", Guid: guid };
